...
public class Category1 {
    ...
    Category1(String textField1) {
        ...
        label4 = new JLabel("Home/Desktop");
        ...
        b4 = new JButton();
        b4.setIcon(new ImageIcon("image/rsz_desktop_1.png"));
        ...
        b5 = new JButton();
        b5.setIcon(new ImageIcon("image/rsz_desktop_2.png"));
        b5.setBounds(380, 160, 300, 220);
        b5.setCursor(new Cursor(Cursor.HAND_CURSOR));
        b5.setBackground(Color.white);
        // b5.setContentAreaFilled(false);
        // b5.setBorderPainted(false);
        l2 = new JButton("Desktop 2");
