...
public class Product8 {
    ...
    Product8(String textField1) {
        ...
        label4 = new JLabel("Home/Desktop/Desktop 8");
        label4.setBounds(100, 125, 500, 60);
        label4.setFont(new Font("Segoe UI", Font.PLAIN, 20));

        label5 = new JLabel("Desktop 8");
        label5.setBounds(600, 190, 1400, 40);
        label5.setFont(new Font("Serif", Font.BOLD, 22));

        label6 = new JLabel(new ImageIcon("image/desktop 8.jpg"));
        // Dimension size1 = label6.getPreferredSize();
        // label6.setBounds(100, 180, size1.width, size1.height);
        label6.setBounds(100, 180, 450, 400);

        label7 = new JLabel("AMD Ryzen 3 3200g, 16 gb RAM,B550 ATX Motherboard, 512  Teams ssd");
        label7.setBounds(610, 230, 480, 40);
        label7.setFont(new Font("Serif", Font.PLAIN, 15));

        label8 = new JLabel("1 tb hdd, Redmibook 75Hz 1080p Monitor, Mouse & Keyboard");
        label8.setBounds(610, 270, 450, 40);
        label8.setFont(new Font("Serif", Font.PLAIN, 15));

        label9 = new JLabel("BDT 32,000.00 ");
        label9.setBounds(610, 380, 240, 40);
        label9.setFont(new Font("Serif", Font.BOLD, 35));

        label10 = new JLabel("29+ reviews");
