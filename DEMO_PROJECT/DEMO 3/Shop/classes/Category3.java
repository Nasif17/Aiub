...
public class Category3 {
    ...
    Category3(String textField1) {
        ...
        label4 = new JLabel("Home/Components");
        ...
        b4 = new JButton();
        b4.setIcon(new ImageIcon("image/motherbord.jpg"));
        b4.setBounds(60, 160, 300, 220);
        b4.setCursor(new Cursor(Cursor.HAND_CURSOR));
        b4.setBackground(Color.white);
        // b4.setContentAreaFilled(false);
        // b4.setBorderPainted(false);
        l1 = new JButton("motherbord");
        ...
        b5 = new JButton();
        b5.setIcon(new ImageIcon("image/rsz_headphone_1.jpg"));
        b5.setBounds(380, 160, 300, 220);
        b5.setCursor(new Cursor(Cursor.HAND_CURSOR));
        b5.setBackground(Color.white);
        // b5.setContentAreaFilled(false);
        // b5.setBorderPainted(false);
        l2 = new JButton("headphone");
        ...
        b6 = new JButton();
        b6.setIcon(new ImageIcon("image/rsz_ssd_6.jpg"));
        ...
        b11 = new JButton();
        b11.setIcon(new ImageIcon("image/grafix.jpg"));
