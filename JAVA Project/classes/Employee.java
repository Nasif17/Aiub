...
import interfaces.*;
 public class  Employee extends JFrame implements  ActionListener,IBasic{
 ...
 public Employee (String userN)
{
    ...
    frame.setDefaultCloseOperation(JFrame. EXIT_ON_CLOSE);
     ...
     // panel1
		...
		p3.setBounds(70,6,800,350);
		p3.setBackground(Color.WHITE);
		p3.setLayout(null);

		JLabel l1 = new JLabel("NOTICES");
		JLabel l2 = new JLabel("Admission Exam , Spring 2023-24, Slot-2 on December 31, 2023 (Sunday)");
		JLabel l3= new JLabel("Holiday Memo: Happy New Year - 2024");
		le1 = new JLabel("IMPORTANT DATES FOR FBA INTERNSHIP STUDENTS FALL-2023-2024");
        le2 = new JLabel("Final-Term Exam Permit distribution of Fall 2023-2024");

		l1.setBounds(350,0,200,50);
		l2.setBounds(0,50,600,50);
		l3.setBounds(0,100,600,50);
		le1.setBounds(0,150,600,50);
		le2.setBounds(0,200,600,50);

        l1.setFont(new Font("Segoe UI",3,30));
		l2.setFont(new Font("Segoe UI",3,17));
		l3.setFont(new Font("Segoe UI",3,17));
		le1.setFont(new Font("Segoe UI",3,17));
		...
		JLabel l13 = new JLabel("Complex Variable,Laplace and Z Transformation[A]");
