...
public class ERoutine extends JFrame implements  ActionListener,IBasic{
    //Frame
    JFrame f;
    ...
    public ERoutine(String userN)
    {
        ...
        l10 = new JLabel("Registrar Office");
        ...
        l13 = new JLabel("Office of Student Affairs");
