...
public class SProfile extends JFrame implements ActionListener, IBasic {
    // Frame
    JFrame f;
    ...
    public SProfile(String userN) {
        ...
        try {
            ...
            if (fr.exists()) {
                ...
                for (int i = 0; i < j; i++) {
                    ...
                    String line = Files.readAllLines(Paths.get(studentPath)).get(i).substring(11);
                    if (line.equals(this.userName)) {

                        firstName = Files.readAllLines(Paths.get(studentPath)).get(i + 2).substring(12);
                        lastName = Files.readAllLines(Paths.get(studentPath)).get(i + 3).substring(11);
                        DOB = Files.readAllLines(Paths.get(studentPath)).get(i + 4).substring(5);
                        Email = Files.readAllLines(Paths.get(studentPath)).get(i + 7).substring(7);
                        Nationality = Files.readAllLines(Paths.get(studentPath)).get(i + 8).substring(13);
                        Gender = Files.readAllLines(Paths.get(studentPath)).get(i + 5).substring(7);
                        break;
                    }
                }
      ...
      System.out.print(ex);
        ...
        // image
        try {
            i = ImageIO.read(new File("images/student.png"));
        ...
        l5 = new JLabel("Credit :    28");
        l5.setBounds(40, 160, 400, 25);
        l5.setFont(new Font("Segoe UI", 3, 17));
        l5.setForeground(c1);
        panel.add(l5);

        l6 = new JLabel("Program :  Bachelor of Science in Computer");
        l6.setBounds(35, 190, 400, 25);
        l6.setFont(new Font("Segoe UI", 3, 17));
        l6.setForeground(c1);
        panel.add(l6);

        l7 = new JLabel("Science & Engineering");
        l7.setBounds(140, 220, 500, 25);
        l7.setFont(new Font("Segoe UI", 3, 17));
        l7.setForeground(c1);
        panel.add(l7);

        l8 = new JLabel("Department :  FACULTY OF SCIENCE & TECHNOLOGY");
        l8.setBounds(35, 250, 450, 25);
        l8.setFont(new Font("Segoe UI", 3, 17));
        l8.setForeground(c1);
        panel.add(l8);

        l9 = new JLabel("Gender :");
        l9.setBounds(35, 280, 500, 25);
        l9.setFont(new Font("Segoe UI", 3, 17));
        l9.setForeground(c1);
        panel.add(l9);

        le9 = new JLabel(this.Gender);
        le9.setBounds(110, 280, 500, 25);
        le9.setFont(new Font("Segoe UI", 3, 17));
        le9.setForeground(c1);
        panel.add(le9);

        l10 = new JLabel("Nationality : ");
        l10.setBounds(35, 310, 500, 25);
        l10.setFont(new Font("Segoe UI", 3, 17));
        l10.setForeground(c1);
        panel.add(l10);

        le10 = new JLabel(this.Nationality);
        le10.setBounds(150, 310, 500, 25);
        ...
        // String ud = System.getProperty("Segoe UI");
